...
A serious buffer overflow vulnerability was found on the UTT router Aggressive  HiPER 810G router, where an attacker could trigger the vulnerability by routing /goform/formPolicyRouteConf, causing buffer overflow attacks and denial of service attacks, etc., specifically through "strcpy((char *)(InstPointByIndex + 140), src_3);" to be realized
